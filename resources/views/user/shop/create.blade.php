        ...
        <div class="col-md-6 col-md-offset-3">
            {!! Form::open(['route' => 'user.shop.store']) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('name', null, [
                        'class' => 'form-control', 
                        'placeholder' => Lang::get('user.message.holder', ['name' => 'tên shop'])
                    ]) !!}
                </div>
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('address', null, [
                        'class' => 'form-control',
                        'placeholder' => Lang::get('user.message.holder', ['name' => 'Địa chỉ'])
                    ]) !!}
                </div>
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('category_id', $categories, null, [
                        'class' => 'form-control',
                        'placeholder' => Lang::get('user.message.select', ['name' => 'chuyên mục'])
                    ]) !!}
                </div>
                ...
                <div class="form-group">
                    ...
                    {!! Form::textarea('description', null, [
                        'class' => 'form-control',
                        'placeholder' => Lang::get('user.message.holder', ['name' => 'mô tả'])
                    ]) !!}
                </div>
